...
% About me
{\RaggedRight
  I’m a \textbf{plant biologist} and \textbf{data educator} passionate about making complex science work in real-world settings. \\
  I enjoy \textbf{leading teams}, ensuring good \textbf{governance}, and enabling \textbf{reproducible analysis}. 
  I thrive where collaboration, {strategy}, and {impact} meet.
}
...
\begin{description}[leftmargin=1em, itemindent=-1em]
  \item \textbf{Bridge builder} between data, policy, and people
  \item Trusted \textbf{educator \& mentor} for 500+ professionals
  \item Skilled \textbf{chair \& negotiator} representing 2000+ PhDs to diverse stakeholders and policy levels
  % \item \textbf{Strategic communicator} across diverse stakeholders and policy levels
  \item Experienced in academic \textbf{project leadership} and team coordination
  \item Advocate for \textbf{open science \& reproducibility}
  \item \textbf{Genomics \& metagenomics expert} (R, Python, Bash)
  \item \textbf{Strong biological background} in plant biology, ecology, and bioinformatics
  % \item \textbf{Workflow developer}: Snakemake, HPC, Docker, Git
\end{description}
}

\GreenHeading{Career Objective}
\begin{spacing}{1}
\noindent
  I aim to grow into a \textbf{leadership role} where I can bridge {science}, {data}, and {people}.  
  % In a role such as {project lead}, {product owner}, or {team manager},  
  I want to \textbf{shape and facilitate} teams' \textbf{ambition} to do \textbf{meaningful work} with {clarity}, {structure}, and {scalable systems}.
\end{spacing}
...
%    \setlength{\parindent}{5em}
  ...
  \item Chaired a council representing $\sim$2000 PhD candidates,
     leading organisational change for new graduation guidelines adopted by three faculties.

...
\begin{description}
  \item \textbf{Genomics \& Bioinformatics}
    \begin{itemize}
  ...
  \item \textbf{Workflow \& Reproducible Research}
    \begin{itemize}
  ...
  \item \textbf{Plant Physiology \& Ecology}
    \begin{itemize}
      ...
      \item \textbf{Control of the \textit{Azolla} symbiosis sexual reproduction: ferns to shed light on the origin of floral regulation?}  
        Preprint (2020). \href{https://doi.org/10.1101/2020.09.09.289736}{DOI}
    \end{itemize}
\end{description}

...
{\fontfamily{pag}\selectfont\RaggedRight
  Passionate about \textbf{data \& reporting for plant science} — turning complex data and genomics into actionable insights. \\
...
\begin{itemize}
  ...
  \item Clear \textbf{communicator} across technical \& non-technical audiences; experienced public speaker from research conferences to public outreach.
...
\begin{description}
  \item Designed and delivered a bioinformatics curriculum from scratch consistently rated a 8+/10 in participant feedback.
    Providing training to 500+ professionals and enabling thorough, more consistent research analyses. 
...
\item Built and maintained a shared bioinformatics server with role-based access; 
      ...
      for coding notebooks linked directly to these datasets — enabling 30{+} researchers to work reproducibly and share analyses.
...
\begin{minipage}[t]{0.6\textwidth}
    ...
    \begin{tabular}{p{1em}p{28em}r}
      \textcolor{ForestGreen}{\faServer}   & HPC \& Workflow Design (Conda, Snakemake) & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\
      \textcolor{ForestGreen}{\faDocker}   & Docker / GitHub (Actions, CI/CD)          & \SkillBull{$\bullet\bullet\bullet\bullet\circ$} \\
      \textcolor{ForestGreen}{\faChartBar} & Data Dashboards (ggplot2, Shiny, Plotly)  & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\
      \textcolor{ForestGreen}{\faBook}     & Reproducible Notebooks (Jupyter, Quarto)  & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\
      \textcolor{ForestGreen}{\faRProject} & R / Python / Bash (advanced scripting and sys-admin)     & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\
      \textcolor{ForestGreen}{\faDatabase} & SQL / Data Governance (PostgreSQL, FAIR)  & \SkillBull{$\bullet\bullet\bullet\circ\circ$} \\
    \end{tabular}
\end{minipage}
\hfill
\noindent

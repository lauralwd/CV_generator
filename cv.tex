...
{\RaggedRight
  ...
  Mensgericht \textbf{verbinder} op het snijvlak van \textbf{data}, \textbf{beleid} en maatschappelijke \textbf{impact}.
  Combineert hands-on ervaring met FAIR data en infrastructuur met verbindend leiderschap en strategisch inzicht.
...
\begin{itemize}[leftmargin=1em, itemindent=0em]
  \item \textbf{Mensgerichte leider:}\\ 
    Benaderbaar, zorgvuldig en verbindend; leidde een team van 20 PhDs en vertegenwoordigde 2.000+ promovendi in beleidsoverleg.
  ...
  \item \textbf{Expert in datavisualisatie en dashboards:} \\
    Docent en ontwerper van een van de best beoordeelde PhD-cursussen aan UU; vertaalt data naar heldere figuren en interactieve dashboards voor diverse doelgroepen.
  \item \textbf{Interdisciplinaire verbinder:} \\ 
    Werkervaring met onderzoekers, beleidsmakers, ITers, docenten, professors en decanen.
  \item \textbf{Strateeg:} \\ 
    Ontwierp datacurriculum voor promovendi (500+ deelnemers, gemiddeld 8+/10).
...
\begin{description}
  ...
  \textbf{Trainer \& curriculumontwerper}  
  Verantwoordelijk voor PhD-cursussen in R, Python, Bash, HPC en datavisualisatie.  
  Focus op FAIR analyse, open workflows en communicatie van data-inzichten richting diverse doelgroepen.  
  ...
  \textbf{Promovendus en docent; verantwoordelijk voor lab data management}  
  Verzekerde €250.000 subsidie voor onderzoek naar (meta)genomics in \textit{Azolla}.  
  Richtte veilige opslag, versiebeheer, gedeelde notebooks en reproduceerbare pipelines in.  
  Samenwerking met Plantum, KeyGene en B-Ware.  

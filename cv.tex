...
% About me
{\RaggedRight
  Biologist focused on microbial profiling and metagenomics with a knack for clear, usable reporting.\
  Data analysis and reporting specialist loving clear dashboards that help non-technical colleagues act on results.\
}
...
\begin{itemize}
  ...
  \item Clear \textbf{communicator} (NL/EN) for technical and non-technical audiences
  \item \textbf{Microbial profiling / metagenomics}; biodiversity data analysis
  \item \textbf{R/Python/HPC} workflows; reproducible pipelines and QA/QC habits
  \item Build \textbf{simple dashboards} and report templates for colleagues and stakeholders
  \item Collaborative \textbf{team player}; comfortable in consensus and committee settings
  \item \textbf{Exposure to soil/sediment data}: sampling and characterisation (MSc; B-Ware collab)
\end{itemize}
\end{spacing}
}
...
\raggedright
  ...
  Microbial profiling / metagenomics of the Azolla symbiosis; designed reproducible analysis pipelines and supported lab colleagues.\\
  Exposure to soil/sediment data via collaboration with B-Ware.\\
  \textit{Molecular Plant Physiology Group, Utrecht University.}\hfill(\href{https://github.com/lauralwd/azolla_phd_thesis}{GitHub})
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2010 -- 2017.}}] \textbf{MSc / BSc} Environmental Plant Biology — MSc internship on seagrass density and sediment erosion (soil/sediment characterisation).\\
...
%\begin{description}
%  \raggedright
  %\item[\normalfont \textcolor{ForestGreen}{\textbf{2022.}}] Basic University Teaching Qualification 
  %(\textbf{bUTQ}), Utrecht University
...
%    \setlength{\parindent}{5em}
  ...
  \item Built reproducible pipelines (nanopore variant calling, pangenomics, phylogeny, metagenomes) and lightweight \textbf{dashboards/report templates} for non-technical users.\\
  (\href{https://github.com/lauralwd/anabaena_nanopore_workflow}{nanopore}\,\href{https://github.com/lauralwd/Nostoc_azollae_pangenomics}{pangenomics}\,\href{https://github.com/lauralwd/lauras_phylogeny_wf}{phylogeny}\,\href{https://github.com/lauralwd/Azolla_genus_meta_pangenome}{metagenome})
  \item Chaired a council representing $\sim$2000 PhD candidates,
     leading organisational change for graduation guidelines adopted by three faculties.
  ...
  \item Built and maintained a small Linux server for \textbf{reproducible analyses} with clear data structures and simple access for experimentalists. \\
  ...
  %   Focus on microbial community data; exposure to soil/sediment measurements.
%\end{itemize}
\end{description}
...
\begin{description}
  \raggedright
  \item \textbf{Lecturer \& Trainer (2022–now)}: Design and deliver modular workshops in 
    R, Python \& Bash for PhD candidates and postdocs, 
    tailoring content to individual research goals and team projects; includes basic dashboards/reporting for research groups 
    (\href{https://github.com/lauralwd/professional_education}{GitHub}).
...
%  \item \textbf{HPC Playground (2025)} – Designed a containerized HPC environment with SLURM and nextflow for young researchers to practice.
  ...
  %\item \textbf{Open Phylogeny Workflow (2021)} – Developed a reproducible JupyterHub workflow for teaching phylogenetics. \href{https://github.com/lauralwd/lauras_phylogeny_wf}{github.com/lauralwd/lauras\_phylogeny\_wf}
%\end{description}
...
\begin{itemize}
  ...
  \item \textbf{Arévalo, S.; Pérez Rico, D.; Abarca, D.; Dijkhuizen, L.W.; et al.} (2022-09-19)  
    “Genome engineering by RNA-guided transposition for \textit{Anabaena} PCC 7120,”

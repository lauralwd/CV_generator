...
{\fontfamily{pag}\selectfont\RaggedRight
  Passionate about \textbf{data, standardisation \& reporting for plant science} — turning complex data and genomics into actionable insights. \\
...
\begin{minipage}[t]{0.6\textwidth}
    ...
    \begin{tabular}{p{1em}p{11em}p{14.5em}r}
      ...
      \textcolor{ForestGreen}{\faRProject} & R / Python / Bash       & (advanced scripting, Sysadmin)       & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\

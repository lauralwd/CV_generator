...
{\RaggedRight
  % Ik ben een \textbf{bioloog}, \textbf{data-educator} en verbindend junior \textbf{leider} 
  % met hart voor maatschappelijke impact, klaar voor de volgende carièrestap.
  Mensgericht \textbf{leider} op het snijvlak van \textbf{data}, \textbf{beleid} en maatschappelijke \textbf{impact}; klaar voor een volgende stap.
...
\raggedright
  ...
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2017 -- 2022.}}] \textbf{Promovendus en docent} 
    ...
    Cofinanciering; samenwerking en PPPs met Plantum, KeyGene en/of B-Ware.\\ % skip because niche?
...
% Management
\GreenHeading{Teamleiding \& Strategisch Coördinatie}
...
\raggedright
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2021 -- 2022.}}] 
    \textbf{Extern advieswerk: }Lid van externe onafhankelijke \textbf{visitatiecommissie} voor de TU Delft voor evaluatie van strategie, prestaties en beleid 
    binnen de afdelingen Chemische Technologie en Biotechnologie. 
    Adviezen vormden input voor het senior management.
    (\href{https://filelist.tudelft.nl/TUDelft/Onderzoek/Kwaliteitsborging/Final report SEP Chemistry TU Delft 20220204.pdf}{Raport}).
  
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2019.}}] \textbf{Interim-leider} 
    van het lab tijdens afwezigheid van de PI.
    Verantwoordelijk voor doorlopend onderzoek, planning, en begeleiding van 6 teamleden en stagaires.
 
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2019 -- heden.}}] 
    Lid van meerdere \textbf{strategische commissies} en overleggremia binnen de Universiteit;
    ...
    \begin{itemize}
      ...
      \item \textbf{UU-wide Open Science Platform} (\href{https://www.uu.nl/en/news/meet-laura-dijkhuizen}{Interview}).
  ...
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2017 -- 2021.}}] \textbf{Voorzitter PhD-Council} en lid van de \textbf{Board of Studies} (GS-LS).
    Ik vertegenwoordigde 2.000+ promovendi t.a.v. (vice)decanen, beleidsmedewerkers en HR in 3 faculteiten. 
    Ik leidde een team van 20 PhDs en vormde beleid in het Board of Studies.
    Als spin in het web stemde ik overlegorganen op elkaar af, met de belangen van promovendi als leidraad.
    % Als voorzitter trok ik een lijn van profesionaliseering binnen en buiten ons overleg. 
\end{description}
...
\begin{description}
  \item Ontwierp en implementeerde een bioinformatica-curriculum vanaf nul met oog op consistente en kwalitatieve data analyse en raportage.
    Ik werd beoordeeld met gemiddeld een 8+/10 door 500+ deelnemers.
  ...
  \item Bouwde een gedeeld data- en analyseplatform met FAIR-structuur, role-based toegang en geïntegreerde notebooks.
    Dit platform stelde 30+ onderzoekers in staat om reproduceerbaar te werken en data-inzichten te delen met belanghebbenden.
...
\begin{description}
  ...
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2022 -- heden}}] \textbf{Docent \& trainer}: 
    ...
    Ik paste mijn cursussen on-the-fly aan de zeer uiteenlopende onderzoeksrichtingen en rollen van de deelnemers, waaronder beleidsmakers, onderzoekers en andere belanghebbenden
    (\href{https://github.com/lauralwd/professional_education}{GitHub})
  ...
  \item[\normalfont \textcolor{ForestGreen}{\textbf{2017 -- 2022}}] \textbf{Begeleider van MSc/BSc scripties}: 
    Ondersteunde studenten bij experimenteel ontwerp, data-analyse en visuele raportage van resultaten.
\end{description}
...
\begin{description}
  ...
  \item Regelmatig actief op \textbf{nationale overleggen} zoals de "Open Science Conference", overleggen van het VSNU en de data.overheid.nl bijeenkomsten.
\end{description}
...
\begin{minipage}[t]{0.6\textwidth}
    ...
    \begin{tabular}{p{1em}p{15em}p{5em}r}
      \textcolor{ForestGreen}{\faServer}   & HPC \& Workflow Ontwerp         & \SkillBull{$\bullet\bullet\bullet\bullet\bullet$} \\
      ...
      \textcolor{ForestGreen}{\faDatabase} & 3D printen en electronica & \SkillBull{$\bullet\bullet\bullet\circ\circ$} \\

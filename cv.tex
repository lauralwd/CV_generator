...
\begin{itemize}
  ...
  \item Skilled \textbf{educator \& mentor} to 400+ PhDs/postdocs
  \item Experienced \textbf{committee chair} \& consensus builder
...
%\begin{itemize}
%  \setlength{\itemsep}{0.0em}
%  \item Excellent \textbf{communicator} across technical and non-technical audiences
%  \item Skilled \textbf{educator \& mentor} for 400+ PhDs/postdocs
%  \item \textbf{Experienced committee chair}, strategic thinker \& consensus builder
%  \item \textbf{Autonomous multitasker} with strong project oversight
%  \item \textbf{Genomics Data science expert} R, Python, Bash/Linux
%  \item \textbf{tech-savy} biologist working with HPC infrastructure, reproducible workflows, Docker and github
%  \item \textbf{Domain specialist} in biology and genomics of plant symbiosis \& environmental interactions.
...
\begin{description}
\raggedright
\item[\normalfont \textcolor{ForestGreen}{\textbf{2023 -- now.}}] Member, Department Advisory Committee, Biology Dept., Utrecht University — shaping strategic priorities\& governance.
\item[\normalfont \textcolor{ForestGreen}{\textbf{2021.}}] External member, TU Delft Research Assessment Committee (Chemical Engineering\& Biotechnology).
\item[\normalfont \textcolor{ForestGreen}{\textbf{2020 -- 2021.}}] Member, Faculty Open Science Implementation Team\& UU Open Science Platform — driving reproducibility policies.
\item[\normalfont \textcolor{ForestGreen}{\textbf{2019 -- 2021.}}] Chair, PhD Council (GSLS) — led ~1,800 PhD representatives; negotiated new graduation guidelines.
\item[\normalfont \textcolor{ForestGreen}{\textbf{2019 -- 2021.}}] Member, Curriculum Committee, M.Sc. Bioinformatics\& Biocomplexity.
\item[\normalfont \textcolor{ForestGreen}{\textbf{2017 -- 2021.}}] PhD Council Representative, Institute of Environmental Biology\& GSLS.
\end{description}
